...
latex_documents = [
    ('index', 'Cognate.tex', u'Cognate Documentation',
...
man_pages = [
    ('index', 'Cognate', u'Cognate Documentation',
     [u'Raul Gonzalez'], 1)
]
...
texinfo_documents = [
    ('index', 'k', u'Cognate Documentation',
     u'Raul Gonzalez', 'Cognate', 'Component Services.',
     'Miscellaneous'),
]
