...
project = u'Cognate'
copyright = u'2016, Raul Gonzalez'
...
with open('../VERSION') as version_file:
    ...
    ver_split = full_version.split('.')
    major_version = ver_split[0] + '.' + ver_split[1]
...
# If true, section author and moduleauthor directives will be shown in the
...
latex_documents = [
    (index_doc, 'Cognate.tex', u'Cognate Documentation',
...
man_pages = [
    (index_doc, 'Cognate', u'Cognate Documentation',
     [u'Raul Gonzalez'], 1)
]
...
texinfo_documents = [
    (index_doc, 'k', u'Cognate Documentation',
     u'Raul Gonzalez', 'Cognate!', 'Sanitarium Inc.',
     'Miscellaneous'),
]
